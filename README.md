...
> [!TIP]
> **On Windows:** `./support-insights` requires a bash shell. It works
> out of the box in **Git Bash** (bundled with
> [Git for Windows](https://git-scm.com/downloads/win) — you already have
> this if you can run `git clone` above). If you're using plain PowerShell
> or Command Prompt instead, use `.\support-insights.ps1` in the project
> folder — same behavior, native PowerShell. If script execution is
> blocked, run once as Administrator:
